...
var ready = function() {
    ...
    displayBubbleChart = function(div, wordsList) {
        /**
            ...
            $.extend(d3.svg.BubbleChart.prototype, {
                ...
                setup: function () {
                    ...
                    self.svg = d3.select(options.container).append("svg")
                        .attr({preserveAspectRatio: "xMidYMid", width: options.size, height: options.size, class: div})
